...
public class ImportServiceImpl {
	...
	public Date dateSql(String input_date) {
		...
		System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa: " + input_date);
		String sub_day = input_date.substring(0,2);
		String sub_month = input_date.substring(3,5);
		String sub_year = input_date.substring(6,10);
	...
	public String import_status(JSONObject json_import, int type_import) {
		...
		String stt = null, project_name= null, customer_name = null, priority_name = null, status_name = null, pic_name = null, muc_do_kha_thi = null;
		...
		// Kiểm tra tên dự án
		if (stt == null) {
			import_status += "stt NULL - ";
		}
		
		// Kiểm tra tên dự án
		if (project_name == null) {
			import_status += "project_name NULL - ";
		}
		...
		if (type_import == 0) {
			import_status += "project_type error - ";
		} else if (type_import != 1) {
...
//		File myFile = new File("D://test/" + file_name + ".xlsx"); 
		File myFile = new File("opt/tomcat/apache-tomcat-8.5.72/webapps/SpringMVCFileUD/upload/"+ file_name + ".xlsx"); 
		...
		String project_name = null, customer_name = null, priority_name = null, status_name = null, 
				am_name = null, pic_name = null, muc_do_kha_thi = null;
...
//					}
				...
				if (import_status != null) {
					if (json_import.get("stt") != null || project_name != null) {
						ImportError importError = new ImportError();
//						importError.setStt((Integer)json_import.get("stt"));
						importError.setProject_name(project_name);
						importError.setImport_error(import_status);
					...
					if (type_import == 1) {
						...
						if (json_import.get("tong_gia_tri_thuc_te") != null) {
